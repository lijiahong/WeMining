...
def cleanCollections():
    ...
    '''
    used = ['friendships', 'statuses', 'period', 'test', 'emotion_test', 'users', 'location', 'target_statuses', 'april_user1', 'april_weibo1', 'user_statuses']
...
if __name__ == '__main__': cleanCollections()
