...
MarkerClusterer.prototype.calculator_ = function(markers, numStyles) {
  ...
  var acc_fipost = 0;
  var acc_repost = 0;
  for(var x = 0;x < markers.length;x = x + 1){
	  acc_fipost = markers[x].fipost + acc_fipost;
	  acc_repost = markers[x].repost + acc_repost;
  }
  var count = acc_fipost + acc_repost;
...
ClusterIcon.prototype.createCss = function(pos) {
  ...
  //var txtColor = this.textColor_ ? this.textColor_ : '#FF0000';
